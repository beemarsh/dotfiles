# Generated by Powerlevel10k configuration wizard on 2024-07-28 at 12:30 EDT.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh.
# Wizard options: nerdfont-v3 + powerline, large icons, classic, ascii, dark, 2 lines,
# solid, sparse, concise, transient_prompt, instant_prompt=verbose.
